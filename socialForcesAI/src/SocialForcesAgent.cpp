...
//
//			awayOb = awayOb + awayObTemp*(_SocialForcesParams.sf_wall_a*exp((((this->radius()) - (this->position() - min_stuff.second).length()) / _SocialForcesParams.sf_wall_b)))*dt;
//
//		}
//	}
//
...
//Vector SocialForcesAgent::calcGoalForce(Vector _goalDirection, float _dt)
//{
//	Util::Vector prefForce = AGENT_MASS*((_goalDirection*PREFERED_SPEED - velocity()) / _dt);
//	return prefForce;
//}
//
//
